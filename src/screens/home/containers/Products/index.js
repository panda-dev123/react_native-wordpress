...
class Products extends React.Component {
  render() {
    // const {data, layout, fields, limit, loading, widthComponent, navigationType} = this.props;
    const {data, fields, limit, loading, widthComponent, navigationType} = this.props;
    const layout = 'list';
    if (
      !fields ||
